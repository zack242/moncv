...
\begin{flushleft}
  ...
  \begin{minipage}[c]{0.8\textwidth}
    ...
    {\Large \textbf{Data Developer | CDI}}
  \end{minipage}
\end{flushleft}
...
\footnotesize{\item{
Ingénieur en Systèmes d'Information et Data Science avec une double formation (ECE Paris/Polytechnique). Solide expérience en développement et en ingénierie des données acquise chez AXA IM. Je recherche un poste en CDI pour contribuer à des projets innovants.
}}
\end{itemize}
...
\begin{itemize}[leftmargin=0in, label={}]
\footnotesize{\item{
{\footnotesize\textbf{Programmation}:} {\footnotesize Python, SQL, C++, C{\#}, Java} \\
\vspace{3pt}
{\footnotesize\textbf{Ingénierie Données Cloud}:} {\footnotesize PySpark, Data Pipelines, Databricks, Snowflake, GCP, Azure, S3, dbt} \\
\vspace{3pt}
{\footnotesize\textbf{Machine Learning}:} {\footnotesize Scikit-Learn, LLM, API Integration} \\
\vspace{3pt}
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Conception et développement d'un système d'authentification multisignature pour les DApps sur la blockchain Kalima}
      \resumeItemListEnd
    \resumeSubheading
      {Le Crédit Lyonnais - LCL}{Janvier 2020 --- Février 2020}
      {IT Intern}{Paris}
      \resumeItemListStart
        \resumeItem{Étude de migration Microsoft Office 2010 vers 2016 et analyse de son impact sur les processus métier}
