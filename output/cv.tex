...
\begin{left}
  ...
  \begin{minipage}[c]{0.8\textwidth}
    {\huge \textbf{Zakaria TOZY}} \\ \vspace{8pt}
...
\begin{itemize}[leftmargin=0in, label={}]
\footnotesize{\item{
{\small\textbf{Programming}:} {\footnotesize Python, SQL, Java, C++, C{\#}} \\
\vspace{3pt}
{\small\textbf{Languages}:} {\footnotesize Français (Bilingue), Arabe (Bilingue), Anglais (Courant - TOEIC 875)} \\
\vspace{3pt}
{\small\textbf{Machine Learning}:} {\footnotesize Scikit-Learn, NLP, Computer Vision, Deep Learning} \\
\vspace{3pt}
{\small\textbf{Devops}:} {\footnotesize Docker, CI/CD, Git, Scrum} \\
\vspace{3pt}
{\small\textbf{Soft Skills}:} {\footnotesize Autonomie, Rigueur, Esprit d'analyse, Apprentissage rapide} \\
\vspace{3pt}
{\small\textbf{Data & Cloud Engineering}:} {\footnotesize PySpark, BigQuery, ETL, Data Pipelines, Databricks, Snowflake, GCP, dbt}
}
}
\end{itemize}
